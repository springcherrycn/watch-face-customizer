...
const texts = {
    'en': { panelTitle: 'Watch Settings', region: 'Timezone', dial: 'Dial Color', bg: 'Background Image', bgHint: 'Upload to ImgBB/SM.MS, copy link, then click Paste', about: 'About', aboutText: 'A minimalist watch face by SpringCherry. All rights reserved. Contact: springcherry@126.com', random: 'Random Color', pasteBtn: 'Paste', pasteSuccess: 'Image loaded!', pasteFail: 'Clipboard read failed.', pasteInvalid: 'Invalid image link.', dialOptions: [{v:'#000000',l:'Black'},{v:'#FFFFFF',l:'White'},{v:'random',l:'Random Color'}], langName: 'English' },
    'ar': { region: 'المنطقة الزمنية', dial: 'لون القرص', bg: 'صورة الخلفية', bgHint: 'ارفع الصورة وانسخ الرابط ثم الصق هنا', about: 'حول', aboutText: 'وجه ساعة بسيط من SpringCherry. جميع الحقوق محفوظة.', random: 'لون عشوائي', pasteBtn: 'لصق', pasteSuccess: 'تم التحميل!', pasteFail: 'فشل القراءة.', pasteInvalid: 'رابط غير صالح.', dialOptions: [{v:'#000000',l:'أسود'},{v:'#FFFFFF',l:'أبيض'},{v:'random',l:'عشوائي'}], langName: 'العربية' },
    'de': { region: 'Zeitzone', dial: 'Zifferblattfarbe', bg: 'Hintergrundbild', bgHint: 'Upload zu ImgBB/SM.MS, Link kopieren und einfügen', about: 'Über', aboutText: 'Ein minimalistisches Zifferblatt von SpringCherry. Alle Rechte vorbehalten.', random: 'Zufallsfarbe', pasteBtn: 'Einfügen', pasteSuccess: 'Bild geladen!', pasteFail: 'Fehler.', pasteInvalid: 'Ungültiger Link.', dialOptions: [{v:'#000000',l:'Schwarz'},{v:'#FFFFFF',l:'Weiß'},{v:'random',l:'Zufall'}], langName: 'Deutsch' },
    'es': { region: 'Zona Horaria', dial: 'Color del Dial', bg: 'Imagen de Fondo', bgHint: 'Sube a ImgBB/SM.MS, copia el enlace y pega', about: 'Acerca de', aboutText: 'Esfera minimalista por SpringCherry. Todos los derechos reservados.', random: 'Color Aleatorio', pasteBtn: 'Pegar', pasteSuccess: '¡Imagen cargada!', pasteFail: 'Error.', pasteInvalid: 'Enlace inválido.', dialOptions: [{v:'#000000',l:'Negro'},{v:'#FFFFFF',l:'Blanco'},{v:'random',l:'Aleatorio'}], langName: 'Español' },
    'fr': { region: 'Fuseau Horaire', dial: 'Couleur du Cadran', bg: 'Image de Fond', bgHint: 'Uploader sur ImgBB/SM.MS, copier le lien et coller', about: 'À propos', aboutText: 'Cadran minimaliste par SpringCherry. Tous droits réservés.', random: 'Couleur Aléatoire', pasteBtn: 'Coller', pasteSuccess: 'Image chargée!', pasteFail: 'Échec.', pasteInvalid: 'Lien invalide.', dialOptions: [{v:'#000000',l:'Noir'},{v:'#FFFFFF',l:'Blanc'},{v:'random',l:'Aléatoire'}], langName: 'Français' },
    'hi': { region: 'समय क्षेत्र', dial: 'डायल रंग', bg: 'पृष्ठभूमि चित्र', bgHint: 'ImgBB/SM.MS पर अपलोड करें, लिंक कॉपी करें और पेस्ट करें', about: 'परिचय', aboutText: 'SpringCherry द्वारा एक मिनिमलिस्ट वॉच फेस। सर्वाधिकार सुरक्षित।', random: 'रैंडम रंग', pasteBtn: 'पेस्ट', pasteSuccess: 'छवि लोड हुई!', pasteFail: 'विफल।', pasteInvalid: 'अमान्य लिंक।', dialOptions: [{v:'#000000',l:'काला'},{v:'#FFFFFF',l:'सफेद'},{v:'random',l:'रैंडम'}], langName: 'हिन्दी' },
    'id': { region: 'Zona Waktu', dial: 'Warna Dial', bg: 'Gambar Latar', bgHint: 'Unggah ke ImgBB/SM.MS, salin tautan lalu tempel', about: 'Tentang', aboutText: 'Wajah jam minimalis oleh SpringCherry. Hak cipta dilindungi.', random: 'Warna Acak', pasteBtn: 'Tempel', pasteSuccess: 'Gambar dimuat!', pasteFail: 'Gagal.', pasteInvalid: 'Tautan tidak valid.', dialOptions: [{v:'#000000',l:'Hitam'},{v:'#FFFFFF',l:'Putih'},{v:'random',l:'Acak'}], langName: 'Bahasa Indonesia' },
    'ja': { region: 'タイムゾーン', dial: '文字盤の色', bg: '背景画像', bgHint: 'ImgBB/SM.MSにアップロードし、リンクをコピーして貼り付け', about: '概要', aboutText: 'SpringCherryによるミニマリストな文字盤。全権利保有。', random: 'ランダム色', pasteBtn: '貼り付け', pasteSuccess: '読み込み完了！', pasteFail: '失敗。', pasteInvalid: '無効なリンク。', dialOptions: [{v:'#000000',l:'黒'},{v:'#FFFFFF',l:'白'},{v:'random',l:'ランダム'}], langName: '日本語' },
    'ko': { region: '시간대', dial: '다이얼 색상', bg: '배경 이미지', bgHint: 'ImgBB/SM.MS에 업로드 후 링크 복사하여 붙여넣기', about: '정보', aboutText: 'SpringCherry의 미니멀 시계 페이스입니다. 모든 권리 보유.', random: '무작위 색상', pasteBtn: '붙여넣기', pasteSuccess: '이미지 로드 완료!', pasteFail: '실패.', pasteInvalid: '잘못된 링크.', dialOptions: [{v:'#000000',l:'검정'},{v:'#FFFFFF',l:'흰색'},{v:'random',l:'무작위'}], langName: '한국어' },
    'ms': { region: 'Zon Masa', dial: 'Warna Dial', bg: 'Imej Latar', bgHint: 'Muat naik ke ImgBB/SM.MS, salin pautan dan tampal', about: 'Perihal', aboutText: 'Muka jam minimalis oleh SpringCherry. Hak cipta terpelihara.', random: 'Warna Rawak', pasteBtn: 'Tampal', pasteSuccess: 'Imej dimuat!', pasteFail: 'Gagal.', pasteInvalid: 'Pautan tidak sah.', dialOptions: [{v:'#000000',l:'Hitam'},{v:'#FFFFFF',l:'Putih'},{v:'random',l:'Rawak'}], langName: 'Bahasa Melayu' },
    'pt': { region: 'Fuso Horário', dial: 'Cor do Mostrador', bg: 'Imagem de Fundo', bgHint: 'Envie para ImgBB/SM.MS, copie o link e cole', about: 'Sobre', aboutText: 'Mostrador minimalista por SpringCherry. Todos os direitos reservados.', random: 'Cor Aleatória', pasteBtn: 'Colar', pasteSuccess: 'Imagem carregada!', pasteFail: 'Falha.', pasteInvalid: 'Link inválido.', dialOptions: [{v:'#000000',l:'Preto'},{v:'#FFFFFF',l:'Branco'},{v:'random',l:'Aleatório'}], langName: 'Português' },
    'ru': { region: 'Часовой пояс', dial: 'Цвет циферблата', bg: 'Фоновое изображение', bgHint: 'Загрузите на ImgBB/SM.MS, скопируйте ссылку и вставьте', about: 'О нас', aboutText: 'Минималистичный циферблат от SpringCherry. Все права защищены.', random: 'Случайный цвет', pasteBtn: 'Вставить', pasteSuccess: 'Загружено!', pasteFail: 'Ошибка.', pasteInvalid: 'Неверная ссылка.', dialOptions: [{v:'#000000',l:'Чёрный'},{v:'#FFFFFF',l:'Белый'},{v:'random',l:'Случайный'}], langName: 'Русский' },
    'th': { region: 'เขตเวลา', dial: 'สีหน้าปัด', bg: 'ภาพพื้นหลัง', bgHint: 'อัปโหลดไปที่ ImgBB/SM.MS คัดลอกลิงก์แล้ววางที่นี่', about: 'เกี่ยวกับ', aboutText: 'หน้าปัดนาฬิกาสไตล์มินิมอลโดย SpringCherry สงวนลิขสิทธิ์', random: 'สีสุ่ม', pasteBtn: 'วาง', pasteSuccess: 'โหลดภาพสำเร็จ!', pasteFail: 'ล้มเหลว', pasteInvalid: 'ลิงก์ไม่ถูกต้อง', dialOptions: [{v:'#000000',l:'ดำ'},{v:'#FFFFFF',l:'ขาว'},{v:'random',l:'สุ่ม'}], langName: 'ไทย' },
    'tl': { region: 'Timezone', dial: 'Kulay ng Dial', bg: 'Larawan sa Likod', bgHint: 'I-upload sa ImgBB/SM.MS, kopyahin ang link at i-paste', about: 'Tungkol', aboutText: 'Minimalist watch face mula sa SpringCherry. Lahat ng karapatan ay nakalaan.', random: 'Random na Kulay', pasteBtn: 'Paste', pasteSuccess: 'Na-load ang imahe!', pasteFail: 'Sira.', pasteInvalid: 'Hindi wastong link.', dialOptions: [{v:'#000000',l:'Itim'},{v:'#FFFFFF',l:'Puti'},{v:'random',l:'Random'}], langName: 'Filipino' },
    'vi': { region: 'Múi giờ', dial: 'Màu mặt số', bg: 'Hình nền', bgHint: 'Tải lên ImgBB/SM.MS, sao chép liên kết và dán vào đây', about: 'Giới thiệu', aboutText: 'Mặt đồng hồ tối giản bởi SpringCherry. Bảo lưu mọi quyền.', random: 'Màu Ngẫu nhiên', pasteBtn: 'Dán', pasteSuccess: 'Tải ảnh thành công!', pasteFail: 'Lỗi.', pasteInvalid: 'Liên kết không hợp lệ.', dialOptions: [{v:'#000000',l:'Đen'},{v:'#FFFFFF',l:'Trắng'},{v:'random',l:'Ngẫu nhiên'}], langName: 'Tiếng Việt' },
    'zh-CN': { region: '时区', dial: '表盘颜色', bg: '背景图片', bgHint: '请上传至ImgBB/SM.MS，复制链接后粘贴', about: '关于我们', aboutText: 'SpringCherry极简表盘，依法享有全部知识产权。', random: '随机颜色', pasteBtn: '粘贴', pasteSuccess: '图片加载成功！', pasteFail: '读取失败。', pasteInvalid: '无效链接。', dialOptions: [{v:'#000000',l:'黑色'},{v:'#FFFFFF',l:'白色'},{v:'random',l:'随机颜色'}], langName: '简体中文' },
    'zh-TW': { region: '時區', dial: '錶盤顏色', bg: '背景圖片', bgHint: '請上傳至ImgBB/SM.MS，複製鏈接後粘貼', about: '關於我們', aboutText: 'SpringCherry極簡錶盤，依法享有全部知識產權。', random: '隨機顏色', pasteBtn: '粘貼', pasteSuccess: '圖片加載成功！', pasteFail: '讀取失敗。', pasteInvalid: '無效鏈接。', dialOptions: [{v:'#000000',l:'黑色'},{v:'#FFFFFF',l:'白色'},{v:'random',l:'隨機顏色'}], langName: '繁體中文' }
};
...
// ✅ 强制默认语言为 English
let currentLang = 'en';
let currentRegionOffset = 8; // 默认备用值
...
function applyLanguage() {
    ...
    // ✅ 填充语言选项 (只显示语言名，如 "English")
    langSelect.innerHTML = '';
    Object.keys(texts).sort().forEach(key => {
        const option = document.createElement('option');
        option.value = key;
        option.textContent = texts[key].langName; // 只显示语言名
...
fetch('https://ipapi.co/json/')
    ...
    .then(data => {
        if (data && data.utc_offset) {
            // utc_offset格式: "+0800" 或 "-0500"
            const offsetStr = data.utc_offset;
            const offsetHours = parseInt(offsetStr.substring(0, 3)); // 提取小时部分
            currentRegionOffset = offsetHours;
            regionSelect.value = offsetHours; // 更新下拉框选中状态
            console.log(`Auto-detected timezone: UTC${offsetHours}`);
        }
    })
    .catch(error => {
